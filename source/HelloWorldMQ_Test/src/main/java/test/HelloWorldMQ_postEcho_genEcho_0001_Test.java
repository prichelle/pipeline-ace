...
public class HelloWorldMQ_postEcho_genEcho_0001_Test {

	/*
	 * HelloWorldMQ_postEcho_genEcho_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.1.0 on Oct 15, 2021 1:49:19 PM
	 */
	...
	@Test
	public void HelloWorldMQ_postEcho_genEcho_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("HelloWorldMQ").messageFlow("gen.HelloWorldMQ")
